...
describe('test suite: Product Class', () => {
  ...
  it('generate an object using Product class', () => {
    expect(
...
describe('test suite: Clothing Class',() => {
  ...
  it('generate an object using Clothing class', () => {
    expect(
    ...
    expect(
      clothing.sizeChartLink
    ).toEqual("images/clothing-size-chart.png");
  });

  it('gets the stars url', () => {
    expect(
      clothing.getStarsUrl()
...
describe('test suite: Appliance Class', () => {
  ...
  it('generate an object using Appliance class', () => {
